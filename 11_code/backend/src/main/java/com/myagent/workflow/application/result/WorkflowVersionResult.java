 ...
 * 工作流版本详情结果。
 */
@Schema(name = "WorkflowVersionResult", description = "工作流版本详情结果。")
public final class WorkflowVersionResult {
     ...
     * 版本号。
     */
    @Schema(description = "版本号。", example = "4", requiredMode = Schema.RequiredMode.REQUIRED)
